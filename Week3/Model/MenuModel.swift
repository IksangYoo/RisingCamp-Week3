...
enum ModelType {
    ...
    var models : [MenuModel] {
        ...
        case .side: return [MenuModel(image: nil, name: "매콤껍데기", priceText: "10,000원", priceInfo: ["":10000]),MenuModel(image: nil, name: "공기밥", priceText: "1,000원",priceInfo: ["":1000]),MenuModel(image: nil, name: "매콤닭발", priceText: "소: 10,000원\n중: 15000" ,priceInfo: ["소":10000,"중":15000])]
            
        case .drink: return [MenuModel(name: "참이슬", priceText: "4,000원"),MenuModel(name: "처음처럼", priceText: "4,000원"),MenuModel(name: "카스", priceText: "4,000원")]
        }
    }
}
